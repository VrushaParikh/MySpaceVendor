...
import com.example.myspacevendor.databinding.ActivityAdminViewShopBinding;
...
public class AdminViewShopActivity extends AppCompatActivity {

    private int shopId = 0;
    private Context context = this;
    private ActivityAdminViewShopBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = ActivityAdminViewShopBinding.inflate(getLayoutInflater());
    ...
    private void handleToolbar() {
        ...
        binding.includedToolbar.title.setText("Admin: Shop Information");
